...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    app.add_exception_handler(SQLAlchemyError, sqlalchemy_error_handler)  # 其他 SQLAlchemy 异常
    app.add_exception_handler(Exception, general_exception_handler)  # 其他异常（兜底）
